...
import IngresoPerfil from "../../IngresoPerfil";
import UrlInvalidaFacebook from "./urlInvalidaFacebook";
    ...
    context('Given I access the search engine page', () => {
        ...
        context('When I write and login in the page', () => {
            ...
            it("Then content and title should not be empty", function () {
                const ingreso = new IngresoPerfil();
                ingreso.ingresoPerfil();
                const urlInvalida = new UrlInvalidaFacebook();
                urlInvalida.urlInvalida();
            })
        })
    })
})